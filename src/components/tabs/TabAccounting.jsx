...
import { Scale, ArrowDownToLine, ArrowUpRight, TrendingUp, Calculator, Calendar, DollarSign } from 'lucide-react';
...
export default function TabAccounting({ 
  ...
  const profitLossMetrics = useMemo(() => {
    ...
    // SINKRONISASI VARIABEL PROTEKSI: Kunci pembagian nol
