...
const StatCard = ({ title, amount, icon, colorClass, textClass }) => (
  <div className={`p-5 rounded-3xl shadow-sm flex flex-col justify-between transition-transform hover:scale-[1.02] duration-300 card-holo ${colorClass}`}>
    <div className="flex justify-between items-start mb-3">
      {/* 🔥 FIX: Hapus uppercase & tracking-wider, ganti normal-case & font-bold */}
  ...
  return (
    <div className="space-y-6 pb-10 text-slate-700 normal-case">
      ...
      <div className="card-holo p-5 rounded-3xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            {/* 🔥 FIX: Hapus uppercase & tracking-widest */}
            <h3 className="text-xs font-bold text-slate-800 normal-case mb-2 flex items-center gap-1.5"><Calendar size={16} className="text-orange-500"/> Filter rentang pemantauan cabang</h3>
      ...
      <div className="card-holo overflow-hidden relative text-slate-700">
          ...
          <div className="p-5 border-b border-slate-100 flex justify-between items-center bg-slate-50/60">
              <div>
                  {/* 🔥 FIX: Hapus uppercase & tracking-widest */}
                  <h2 className="text-sm font-extrabold text-slate-800 flex items-center gap-2 normal-case"><Factory className="text-orange-500"/> Pantauan live hasil dapur produksi (Pemalang)</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 divide-y md:divide-y-0 md:divide-x divide-slate-100 text-center bg-white">
              ...
              <div className="p-5 hover:bg-slate-50 transition-colors bg-slate-50/30 relative">
                  ...
                  {/* 🔥 FIX: Hapus uppercase & tracking-wider */}
      ...
      <div className="card-holo p-6">
          <div className="mb-5 border-b border-slate-100 pb-3">
              {/* 🔥 FIX: Hapus uppercase & tracking-widest */}
              <h2 className="text-xs font-extrabold text-slate-800 normal-case flex items-center gap-1.5"><Wallet size={16} className="text-red-500"/> Analitik keuangan buku cabang Pemalang</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 card-holo p-5 flex flex-col max-h-[415px]">
            {/* 🔥 FIX: Hapus tracking-widest */}
            <h3 className="font-extrabold text-slate-800 text-xs normal-case flex items-center gap-2 mb-4 border-b border-slate-100 pb-2"><Users size={16} className="text-red-500"/> Klasemen pelanggan terloyal</h3>
