      ...
      <div className="print-wrapper shadow-xl">
        ...
        <div className="mt-4">
            ...
            <table className="table-pro">
                ...
                <tbody>
                    <tr><td className="font-bold text-base">{formatRp(totalTagihan)}</td><td className="font-bold text-base text-emerald-600">{formatRp(totalTerbayar)}</td><td className="font-black text-base text-red-600">{formatRp(sisaTagihanAktual)}</td><td className="font-black text-base">{sisaTagihanAktual <= 0 ? 'LUNAS' : 'BELUM LUNAS'}</td></tr>
                </tbody>
            </table>
        </div>
  ...
  return (
    <div className="bg-slate-100 min-h-screen p-4">
      ...
      <div className="print-wrapper shadow-xl">
        ...
        <table className="table-pro">
          <thead>
            <tr><th className="w-8">NO</th><th className="text-left w-64">KATEGORI PENGELUARAN</th><th className="text-left">KETERANGAN / RINCIAN</th><th className="w-40 text-right">TOTAL</th></tr>
          </thead>
          <tbody>
        ...
        <table className="table-print">
          ...
          <tbody>
            {(!rekap?.listTransaksiDetail || rekap.listTransaksiDetail.length === 0) ? (
                <tr><td colSpan="8" className="text-center py-6 italic text-slate-500">Tidak ada transaksi di periode ini.</td></tr>
            ) : (
                rekap.listTransaksiDetail.map((c, i) => (
                    <tr key={i}>
                        ...
                        <td className="text-center text-xs">{c.paymentMethod}</td>
              ...
              <tbody>
                {rekap.listRiwayatPiutang.map((p, i) => (
                  <tr key={i}>
                    ...
                    <td className="text-center text-xs">{p.paymentMethod}</td>
        ...
        <table className="table-print">
          ...
          <tbody>
            {(!rekap?.listOrders || rekap.listOrders.length === 0) ? (
                <tr><td colSpan="8" className="text-center py-6 italic text-slate-500">Tidak ada transaksi penjualan cabang.</td></tr>
            ) : (
