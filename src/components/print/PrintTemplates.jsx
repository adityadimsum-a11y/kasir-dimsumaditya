            ...
            {(!rekap?.listPiutangBerjalan || rekap.listPiutangBerjalan.length === 0) ? (
                ...
                rekap.listPiutangBerjalan.map((p, i) => {
                  ...
                  <tr key={i}>
                    ...
                    <td className="text-right text-emerald-600">{formatRp((p?.totalDibayar || 0) + (p?.cicilanTerbayar || 0))}</td>
                    ...
                    <td className="text-center font-bold text-[9px] text-red-600">
                        BELUM LUNAS
                        {isNew && <div className="text-orange-600 font-black mt-0.5">(PIUTANG BARU)</div>}
                    </td>
                  </tr>
                )})
            )}
            ...
            {(!rekap?.listHutangBerjalan || rekap.listHutangBerjalan.length === 0) ? (
                ...
                rekap.listHutangBerjalan.map((p, i) => {
                  ...
                  <tr key={i}>
                    ...
                    <td className="text-center font-bold text-[9px] text-red-600">
                        BELUM LUNAS
                        {isNew && <div className="text-red-600 font-black mt-0.5">(HUTANG BARU)</div>}
                    </td>
                  </tr>
                )})
            )}
